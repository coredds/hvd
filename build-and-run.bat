@echo off
REM hvd Media Downloader - Build and Run Script (Windows)
REM This script builds the JAR and runs it with proper JavaFX configuration
...
REM Launch JAR with JavaFX runtime
java ^
